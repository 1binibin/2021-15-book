...
CREATE TABLE IF NOT EXISTS `users_api` (
  ...
  `domain` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '허용 가능 도메인',
  `apikey` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'uuid4',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `users_sns` (
  ...
  `snsname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'sns 사용자 이름',
...
CREATE TABLE IF NOT EXISTS `users_withdrawal` (
  ...
  `msg` text COLLATE utf8mb4_general_ci COMMENT '회원  탈퇴 사유',
